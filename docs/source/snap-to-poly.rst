...
Snap to Poly function was created for this exact purpose and in conjunction with Randomize Transforms (from :ref:`instance<instance-page>`) it can be a powerful detailing and modeling tool.

You can change the behavior of Snap to Poly by accessing its marking menu (Hold RMB on the button)
